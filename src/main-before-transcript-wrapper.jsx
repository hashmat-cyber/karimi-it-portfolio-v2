            ...
            <div style={{
              ...
              >
                <GlassCard>
                  ...
                  <span className="eyebrowSmall" style={{display: "block", marginTop: "12px"}}>
                    <span className="transcript-caption-icon">▣</span><span className="transcript-caption-label">TRANSCRIPT PAGE 01</span>
                  </span>
              ...
              >
                <GlassCard>
                  ...
                  />
                  <span className="eyebrowSmall" style={{display: "block", marginTop: "12px"}}>
                    <span className="transcript-caption-icon">▣</span><span className="transcript-caption-label">TRANSCRIPT PAGE 02</span>
                  </span>
                  <div className="transcript-caption-title">
                    Azeraksh Tuition Transcript
                  </div>
