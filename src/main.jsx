  ...
  return <div className="app">
    ...
    <footer className="footer">
      ...
      <div className="container footerBottom">
        ...
        <span>Information Technology · {t.back}</span>
      </div>
    </footer>
  </div>
}
...
function Home({t}){const nav=useNavigate();return <>
  <section className="homeHero"><div className="heroGrid"/><div className="heroGlow glowA"/><div className="heroGlow glowB"/><div className="container heroLayout">
    ...
    <div className="heroVisual"><div className="orbital orb1"/><div className="orbital orb2"/><div className="visualFrame"><div className="frameTop"><span><CircleDot/> LIVE PROFILE</span><span>01 / 04</span></div><div className="profileFallback"><img src="/assets/images/profile/profile.jpg" alt="Sayed Hashmat Karimi" /><div className="scanline"/></div><div className="profileCaption"><div><span>IDENTITY</span><b>SAYED HASHMAT KARIMI</b></div><div><span>FIELD</span><b>INFORMATION TECHNOLOGY</b></div></div></div><div className="techChip chip1"><Network/><span>NETWORK</span></div><div className="techChip chip2"><Database/><span>DATABASE</span></div><div className="techChip chip3"><Code2/><span>PYTHON</span></div><div className="terminalMini"><span>&gt;_ learning.mode</span><b>BUILD · TEST · IMPROVE</b></div></div>
  </div></section>
  <section className="marquee"><div className="container marqueeInner">{t.chips.map((x,i)=><span key={x}><Zap/> {x} <i>·</i></span>)}<span><Sparkles/> PRACTICAL IT</span></div></section>
  <section className="section homeBento"><div className="container bentoIntro"><div><span className="sectionEyebrow">01 <i/> PROFILE</span><h2>{t.aboutTitle}</h2></div><p>{t.aboutText}</p></div><div className="container bentoGrid"><GlassCard className="bentoLarge"><span className="cardIndex">01</span><div className="bigIcon"><Cpu/></div><span className="eyebrowSmall">MY APPROACH</span><h3>Learning by Building</h3><p>I believe the best way to learn IT is to understand the basics, build practical projects and improve through real problems. I focus on turning what I learn into working systems instead of only studying theory.</p><div className="principles"><div><Code2/><b>Build</b><span>Practical projects using Python, Flask, SQL and web technologies</span></div><div><Layers3/><b>Explore</b><span>Computer systems, networking, databases and Linux</span></div><div><Target/><b>Improve</b><span>Testing, troubleshooting and learning from mistakes</span></div></div><Link to="/about" className="cardLink">{t.about}<ArrowUpRight/></Link></GlassCard><GlassCard className="bentoFocus"><span className="eyebrowSmall">CURRENT FOCUS</span><div className="focusRows">{t.focus.slice(0,4).map((x,i)=><div key={x}><b>0{i+1}</b><span>{x}</span><CheckCircle2/></div>)}</div></GlassCard><GlassCard className="bentoMetric"><span className="eyebrowSmall">ACADEMIC RESULT</span><strong>90%</strong><p>Overall school result · 90 out of 100</p><div className="metricLine"><i/></div></GlassCard><GlassCard className="bentoMetric second"><span className="eyebrowSmall">PROJECT MINDSET</span><strong>03</strong><p>Practical IT projects</p><div className="nodeMap"><i/><i/><i/><i/></div></GlassCard></div></section>
</>}
...
function Resume({t}){return <><PageHero num="08" title={t.resumeTitle} sub={t.resumeSub}/><section className="section"><div className="container resumeGrid"><GlassCard className="resumeMain"><div className="resumeHeader"><div><span className="eyebrowSmall">PROFILE</span><h2>Sayed Hashmat Karimi</h2><p>{t.role}</p></div><div className="resumeCode">SK<br/><span>IT</span></div></div><div className="resumeRows"><div><GraduationCap/><span>Education</span><b>Qabilbay School · 2026</b></div><div><Code2/><span>Technical focus</span><b>Python · Web · Networking · Databases</b></div><div><Award/><span>Credentials</span><b>CS50x · CS50P · CS50 SQL · ICDL</b></div><div><Layers3/><span>Projects</span><b>3 practical IT projects</b></div></div><button className="btn btnPrimary resumeBtn"><Download/>Download Resume</button></GlassCard><GlassCard className="resumeSide"><span className="eyebrowSmall">CORE SIGNALS</span><div className="signal"><strong>90%</strong><span>Overall school result</span></div><div className="signal"><strong>03</strong><span>Featured projects</span></div><div className="signal"><strong>04+</strong><span>Technical credentials</span></div></GlassCard></div></section></>}
